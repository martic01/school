      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          ...
          <motion.div
            ...
            className="md:col-span-2 bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-6 border-2 border-purple-200 hover:shadow-lg transition-all duration-300"
          >
            <div className="flex items-start gap-4 mb-4">
              <div className="p-3 bg-gradient-to-br from-purple-600 to-blue-600 rounded-lg text-white flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-purple-600 text-sm font-medium mt-1">{featuredProducts[0].tagline}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="bg-white p-3 rounded-lg text-center border border-purple-100">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all flex-1 justify-center"
              >
              ...
              <button
                ...
                className="text-sm text-purple-600 hover:text-purple-700 font-medium px-3 py-2 hover:bg-purple-50 rounded-lg transition-colors"
              >
                Learn more →
              </button>
            </div>

...
import { ceoDatas } from "../data/Data";

const statsIcons = [FaAward, FaLightbulb]; // icons in order for stats

const AboutCEO = () => {
  const textRef = useRef(null);
  const ceoData = ceoDatas;
                ...
                >
                  <div className="grid grid-cols-2 gap-3">
                    {ceoData.stats.map((stat, index) => {
                      const StatIcon = statsIcons[index] || FaAward;
                      return (
